...
class ImageMetadata:
    ...
    def automatic1111_metadata(user_config: dict, attributes: dict):
        ...
        a1111_output = f'{a1111_output}\nSteps: {user_config.get("steps", 0)}, Sampler: {attributes.get("scheduler", "DDIM")}, CFG scale: {attributes.get("guidance_scaling", user_config.get("guidance_scaling"))}, Seed: {attributes["seed"]}, Size: {user_config["width"]}x{user_config["height"]}, Model hash: 12345678'
